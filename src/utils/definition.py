...
class Teleport:
    ...
    def from_dict(cls, data: dict):
        return cls(data["x"] * GameSettings.TILE_SIZE, data["y"] * GameSettings.TILE_SIZE, data["destination"], data["dest_x"]* GameSettings.TILE_SIZE, data["dest_y"] * GameSettings.TILE_SIZE)
